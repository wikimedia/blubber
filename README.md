...
$ buildctl build --frontend gateway.v0 \
  --opt source=docker-registry.wikimedia.org/repos/releng/blubber/buildkit:v1.2.0 \
  --local context=. \
  --local dockerfile=. \
...
```yaml
# syntax=docker-registry.wikimedia.org/repos/releng/blubber/buildkit:v1.2.0
version: v4
variants:
  my-variant:
  [...]
